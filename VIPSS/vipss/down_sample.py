...
points = np.loadtxt("../data/mic/point_cloud.xyz")  # shape: (N, 3)
...
np.savetxt("../data/mic/point_cloud_ds.xyz", points_ds, fmt="%.6f")
print(f"Downsampled from {points.shape[0]} → {points_ds.shape[0]} points")
